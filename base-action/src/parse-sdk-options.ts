...
export function parseSdkOptions(options: ClaudeOptions): ParsedSdkOptions {
  ...
  // The action prepends its config (gitea_comment, gitea_ci, etc.) as inline JSON,
  ...
  if (process.env.INPUT_ACTION_INPUTS_PRESENT) {
    ...
    env.GITEA_ACTION_INPUTS = process.env.INPUT_ACTION_INPUTS_PRESENT;
  }
  // Set the entrypoint for Claude Code to identify this as the Gitea Action
  env.CLAUDE_CODE_ENTRYPOINT = "claude-code-gitea-action";
