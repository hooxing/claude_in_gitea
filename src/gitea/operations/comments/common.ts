...
export const SPINNER_HTML =
  '<img src="https://raw.githubusercontent.com/anthropics/claude-code-action/main/docs/spinner.gif" width="14px" height="14px" style="vertical-align: middle; margin-left: 4px;" />';
